 ...
 * @author pazjo
 */
public class SuccesGUI extends javax.swing.JFrame {

    /**
     * Creates new form EditGUI
     */
    public SuccesGUI(String texto) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/succes.png"))); // NOI18N
        jLabel1.setText("Función no implementada en esta versión");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuccesGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
