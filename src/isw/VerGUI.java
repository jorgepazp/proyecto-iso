 ...
 * @author pazjo
 */
public class VerGUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
